...
export const SizeForm: React.FC<SizeFormProps> = ({
  ...
  const description = initialData ? 'Edite os tamanhos.' : 'Adicione um novo tamanho';
  const toastMessage = initialData ? 'Tamanho salvo.' : 'Tamanho criado.';
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error('Certifique-se de remover todos os produtos usando este tamanho primeiro.');
    } finally {
      setLoading(false);
      setOpen(false);
    }
